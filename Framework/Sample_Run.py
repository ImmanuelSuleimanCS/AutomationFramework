...
from Framework import WolfPakApi
from Framework.auth_manager import AuthenticationManager

# import functions
from Report_Automation import report_automation_20230403 as ReportAutomation
from Teamwork_Data_Automation import Run_All_Tasks as Teamwork
from Finley_DownWell_Process import ExecuteFinleyDWP
...
if auth_manager.authenticate(username, password):
    ...
    scheduled_functions = [WolfPakApi.ScheduledFunctionExecutor(function=ReportAutomation.main,
                                  source="ReportAutomation",
                                  schedule_method='schedule_daily',
                                  schedule_params={'hour': RUN_NUM},
                                  arguments={'test_run': False}),
        WolfPakApi.ScheduledFunctionExecutor(function=ExecuteFinleyDWP.main,
                                  source="ExecuteFinleyDWP",
                                  schedule_method='schedule_daily',
                                  schedule_params={'hour': RUN_NUM},
                                  arguments={'test_run': False}),
        WolfPakApi.ScheduledFunctionExecutor(function=Teamwork.main,
                                  source="Teamwork",
                                  schedule_method='schedule_daily',
                                  schedule_params={'hour': RUN_NUM},
                                  arguments={'test_run': False})]
...
if current_hour >= __start__ and current_hour < __stop__:
    WolfPakApi.EmailSender.send_mail(send_from='admin@company.com',
